...
List$OverallAcc
#user accuracy
data.frame(Landcover=Classes[,-1],User=as.data.frame(List$byClass)[,'Precision'])
#Producer accuracy
data.frame(Landcover=Classes[,-1],Producer=as.data.frame(List$byClass)[,'Sensitivity'])
```
