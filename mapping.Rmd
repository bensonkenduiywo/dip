...
rf.pca <- randomForest(code~., data=na.omit(as.data.frame(train.pca[,-1]@data)), ntree = 250, importance=T)
...
varImpPlot(rf.pca,sort=TRUE, n.var=min(dim(pca)[3], nrow(rf.pca$importance)), type = 1)
