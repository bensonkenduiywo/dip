...
We can see that RMSE and MAPE have reduced by small margins compared to the case of random sampling. Thus there is a chance that sampling over different land-cover improves prediction. 
