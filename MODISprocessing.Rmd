...
The plot shows the pixels that pass the quality check (i.e., the pixels that shall be retained). Subsequently, the mask operation can be applied to all other images considering **NDVI** and **EVI** quality flags. For instance, the **NDVI* quality mask can be obtained as shown below. 
...
The data can also be normalized using minimum and maximum values of the image.
